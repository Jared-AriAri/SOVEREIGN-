...
export const products: Product[] = [
  {
    ...
    description:
      "Perfect for homes, home offices and small businesses. Compact, elegant and easy to use. Powered by Watergen GENius™ technology.",
    badge: "Most Popular",
  },
  {
    id: "gen-m1",
    ...
    description:
      "Modular solution for schools, clinics, small hotels and off-grid sites. Scalable and efficient. Ideal for community-scale water independence.",
  },
  {
    id: "gen-m-pro",
    model: "GEN-M Pro",
    ...
    description:
      "Commercial-grade production for facilities that need reliable, high daily output with a compact footprint. Ideal for tribal community centers and campuses.",
  ...
  },
  {
    ...
    description:
      "Large-scale solution for villages, hospitals, mining sites, military bases and industrial facilities. The ultimate water independence solution for tribal nations.",
    badge: "High Capacity",
  },
  {
    id: "gen-m1-solar",
    ...
    description:
      "Solar-powered variant of the GEN-M1 for complete off-grid water independence. Perfect for remote tribal communities without reliable grid access.",
    badge: "Solar Ready",
  },
  {
    id: "gen-l-plus",
    ...
    description:
      "Municipal-scale atmospheric water generation for large tribal communities, government facilities, and industrial operations. The flagship solution for water sovereignty.",
    badge: "Municipal Scale",
  },
];

export const WHATSAPP_NUMBER = "12146007494";
export const CONTACT_EMAIL = "contact@sovereign.water";
